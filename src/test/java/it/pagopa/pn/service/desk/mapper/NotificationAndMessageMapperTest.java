...
class NotificationAndMessageMapperTest {
    ...
    void initialize (){
        ...
        notificationSearchRowDto.setNotificationStatus(it.pagopa.pn.service.desk.generated.openapi.msclient.pndelivery.v1.dto.NotificationStatusV28Dto.ACCEPTED);
